...
# July/August 2001
# -------------
# September 2001 modification: now it doesn't send an output per component. Just one per external event!
# -------------
#
...
# Level used: $total
# The int and ext delays are used in the Internal and External transitions... "for(i=0;i<intDelay;i++) { }"
texto
